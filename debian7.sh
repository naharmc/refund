...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/wilkingdead/setup2/master/badvpn-udpgw"
...
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/wilkingdead/setup2/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/wilkingdead/setup2/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/wilkingdead/setup2/master/mrtg.conf" >> /etc/mrtg.cfg
...
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/vnstat_php_frontend-1.5.1.tar.gz
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/wilkingdead/setup2/master/squid.conf"
...
# User Status
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/user-list.sh
mv ./user-list.sh /usr/local/bin/user-list.sh
chmod +x /usr/local/bin/user-list.sh

# Install Dos Deflate
apt-get -y install dnsutils dsniff
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/ddos-deflate-master.zip
...
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/update.sh
mv ./update.sh /usr/bin/update.sh
chmod +x /usr/bin/update.sh

# instal Buat Akun SSH/OpenVPN
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/buatakun.sh
mv ./buatakun.sh /usr/bin/buatakun.sh
chmod +x /usr/bin/buatakun.sh

# instal Generate Akun SSH/OpenVPN
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/generate.sh
mv ./generate.sh /usr/bin/generate.sh
chmod +x /usr/bin/generate.sh

# instal Generate Akun Trial
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/trial.sh
mv ./trial.sh /usr/bin/trial.sh
chmod +x /usr/bin/trial.sh

# instal  Ganti Password Akun SSH/VPN
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/userpass.sh
mv ./userpass.sh /usr/bin/userpass.sh
chmod +x /usr/bin/userpass.sh

# instal Generate Akun SSH/OpenVPN
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/userrenew.sh
mv ./userrenew.sh /usr/bin/userrenew.sh
chmod +x /usr/bin/userrenew.sh

# instal Hapus Akun SSH/OpenVPN
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/userdelete.sh
mv ./userdelete.sh /usr/bin/userdelete.sh
chmod +x /usr/bin/userdelete.sh

# instal Cek Login Dropbear, OpenSSH & OpenVPN
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/userlogin.sh
mv ./userlogin.sh /usr/bin/userlogin.sh
chmod +x /usr/bin/userlogin.sh

# instal Auto Limit Multi Login
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/autolimit.sh
mv ./autolimit.sh /usr/bin/autolimit.sh
chmod +x /usr/bin/autolimit.sh

# instal Auto Limit Script Multi Login
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/auto-limit-script.sh
...
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/userdetail.sh
mv ./userdetail.sh /usr/bin/userdetail.sh
chmod +x /usr/bin/userdetail.sh

# instal Delete Akun Expire
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/deleteuserexpire.sh
mv ./deleteuserexpire.sh /usr/bin/deleteuserexpire.sh
chmod +x /usr/bin/deleteuserexpire.sh

# instal  Kill Multi Login
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/autokilluser.sh
mv ./autokilluser.sh /usr/bin/autokilluser.sh
chmod +x /usr/bin/autokilluser.sh

# instal  Kill Multi Login2
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/autokill.sh
...
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/userunban.sh
mv ./userunban.sh /usr/bin/userunban.sh
chmod +x /usr/bin/userunban.sh

# instal Mengunci Akun SSH & OpenVPN
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/userlock.sh
mv ./userlock.sh /usr/bin/userlock.sh
chmod +x /usr/bin/userlock.sh

# instal Membuka user SSH & OpenVPN yang terkunci
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/userunlock.sh
...
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/loglimit.sh
...
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/logban.sh
mv ./logban.sh /usr/bin/logban.sh
chmod +x /usr/bin/logban.sh

# instal Buat Akun PPTP VPN
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/useraddpptp.sh
mv ./useraddpptp.sh /usr/bin/useraddpptp.sh
chmod +x /usr/bin/useraddpptp.sh

# instal Hapus Akun PPTP VPN
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/userdeletepptp.sh
mv ./userdeletepptp.sh /usr/bin/userdeletepptp.sh
chmod +x /usr/bin/userdeletepptp.sh

# instal Lihat Detail Akun PPTP VPN
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/detailpptp.sh
mv ./detailpptp.sh /usr/bin/detailpptp.sh
chmod +x /usr/bin/detailpptp.sh

# instal Cek login PPTP VPN
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/userloginpptp.sh
mv ./userloginpptp.sh /usr/bin/userloginpptp.sh
chmod +x /usr/bin/userloginpptp.sh

# instal Lihat Daftar User PPTP VPN
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/alluserpptp.sh
mv ./alluserpptp.sh /usr/bin/alluserpptp.sh
chmod +x /usr/bin/alluserpptp.sh

# instal Set Auto Reboot
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/autoreboot.sh
...
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/speedtest.py.sh
...
# instal diagnosa
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/diagnosa.sh
mv ./diagnosa.sh /usr/bin/diagnosa.sh
chmod +x /usr/bin/diagnosa.sh

# instal ram
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/ram.sh
mv ./ram.sh /usr/bin/ram.sh
chmod +x /usr/bin/ram.sh

# log install
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/log-install.sh
mv ./log-install.sh /usr/bin/log-install.sh
chmod +x /usr/bin/log-install.sh

# edit ubah-port
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/ubahport.sh
mv ./ubahport.sh /usr/bin/ubahport.sh
chmod +x /usr/bin/ubahport.sh

# edit-port-dropbear
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/edit-port-dropbear.sh
mv ./edit-port-dropbear.sh /usr/bin/edit-port-dropbear.sh
chmod +x /usr/bin/edit-port-dropbear.sh

# edit-port-openssh
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/edit-port-openssh.sh
mv ./edit-port-openssh.sh /usr/bin/edit-port-openssh.sh
chmod +x /usr/bin/edit-port-openssh.sh

# edit-port-openvpn
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/edit-port-openvpn.sh
mv ./edit-port-openvpn.sh /usr/bin/edit-port-openvpn.sh
chmod +x /usr/bin/edit-port-openvpn.sh

# edit-port-openvpn
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/edit-port-squid.sh
mv ./edit-port-squid.sh /usr/bin/edit-port-squid.sh
chmod +x /usr/bin/edit-port-squid.sh

# restart
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/restart.sh
mv ./restart.sh /usr/bin/restart.sh
chmod +x /usr/bin/restart.sh

# restart-dropbear
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/restart-dropbear.sh
mv ./restart-dropbear.sh /usr/bin/restart-dropbear.sh
chmod +x /usr/bin/restart-dropbear.sh

# restart-squid
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/restart-squid.sh
mv ./restart-squid.sh /usr/bin/restart-squid.sh
chmod +x /usr/bin/restart-squid.sh

# restart-openvpn
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/restart-openvpn.sh
mv ./restart-openvpn.sh /usr/bin/restart-openvpn.sh
chmod +x /usr/bin/restart-openvpn.sh

# restart-webmin
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/restart-webmin.sh
mv ./restart-webmin.sh /usr/bin/restart-webmin.sh
chmod +x /usr/bin/restart-webmin.sh

# disable-user-expire
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/disable-user-expire.sh
mv ./disable-user-expire.sh /usr/bin/disable-user-expire.sh
chmod +x /usr/bin/disable-user-expire.sh

# bannerssh
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/bannerssh
...
# Install Menu
cd
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/menu
mv ./menu /usr/local/bin/menu
chmod +x /usr/local/bin/menu

# home deletesuerexpire
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/deleteuserexpire.sh
mv ./deleteuserexpire.sh /usr/local/bin/deleteuserexpire.sh
chmod +x /usr/local/bin/deleteuserexpire.sh

# download script
cd
wget -q -O /usr/bin/welcomeadmin https://raw.githubusercontent.com/wilkingdead/setup2/master/welcome.sh
wget -O /etc/bannerssh "https://raw.githubusercontent.com/wilkingdead/setup2/master/config/bannerssh"
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/config/deleteuserexpire.sh
...
wget https://raw.githubusercontent.com/wilkingdead/setup2/master/fstab
mv ./fstab /etc/fstab
chmod 644 /etc/fstab
...
rm -f /root/user-expired.sh
rm -f /root/deleteuserexpire.sh
