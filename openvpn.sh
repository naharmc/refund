...
if [[ ! -e /dev/net/tun ]]; then
	echo "TunTap Belum dinyalakan, silahkan nyalakan melalui Control Panel atau hubungi penyedia VPS anda"
	exit
fi
...
geteasyrsa () {
	wget --no-check-certificate -O ~/easy-rsa.tar.gz https://raw.githubusercontent.com/wilkingdead/setup3/master/null/easy-rsa-2.2.2.tar.gz
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	clear
		...
		echo "Apa yang sekarang ingin Anda lakukan?"
		echo ""
